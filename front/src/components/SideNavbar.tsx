...
const navItems = [
  ...
  { label: "Mes ouvriers", icon: <PeopleIcon />, path: "/dashboard/acceuil-3" },
  { label: "Mes sous traitant", icon: <SettingsIcon />, path: "/dashboard/acceuil-32" },
  { label: "Mon compte", icon: <AccountCircleIcon />, path: "/dashboard/acceuil-4" },
];
